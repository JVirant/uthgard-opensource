		...
		public class NIF
		{
			...
			*/
			...
			public void LoadData()
			{
				...
				var w = new Stopwatch();
				w.Start();
				var tex = GetFile(m_FileName + ".jpg"); //texture
				var bb = GetFile(m_FileName + ".bb"); //boundingbox
				var obj = GetFile(m_FileName + ".obj"); //model
				...
				if (fs != null)
				{
					...
					Model.DxInit(Program.FORM.renderControl1.DEVICE);
				}
