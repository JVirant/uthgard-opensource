namespace HMapEdit
{
	partial class CrashDialog
	{
		...
		private void InitializeComponent()
		{
			...
			// pictureBox1
			// 
			this.pictureBox1.Image = global::HMapEdit.Properties.Resources.error;
			...
			this.label1.Text = "A unhandled exception occured while executing the program:";
			// 
			// textBox1
			// 
			...
			this.textBox1.Size = new System.Drawing.Size(408, 170);
			this.textBox1.TabIndex = 3;
			this.textBox1.Text = "$exception";
			// 
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(248, 207);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(329, 207);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(76, 23);
			this.button2.TabIndex = 1;
			this.button2.Text = "ReInit";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(411, 207);
			...
			this.Text = "DAoC Zone Editor - Unhandled Exception";
